...
const seedDatabase = async () => {
  ...
  try {
    ...
    const usuarios = [
      { nombre: 'Juan Organizador', email: 'juan@prueba.com', rol: 'organizador' },
      { nombre: 'María Asistente', email: 'maria@prueba.com', rol: 'asistente' },
      { nombre: 'Pedro Guardia', email: 'pedro@prueba.com', rol: 'guardia' }
    ]
